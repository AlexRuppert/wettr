...
{#if showInstallButton && showInstallOverlay}
  <div
    class="flex w-full right-0 bottom-1 left-0 justify-center fixed"
    transition:scale
  >
    <div
    ...
    >
      ...
      <span class="h-5 w-5 inline-block align-middle">
        <svg
          viewBox="0 0 22 22"
          stroke="#0a67c9"
          stroke-width="2"
        ...
        >
          <path
            d="M8,7H7a2,2 0 0,0 -2,2V16a2,2 0 0,0 2,2H14a2,2 0 0,0 2,-2V9a2,2 0 0,0 -2,-2H13M10.5,13V1l3,3M10.5,1l-3,3"
          />
        </svg>
      </span>
      und
